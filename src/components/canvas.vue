...
<!--touchstart,touchmove,touchend,touchcancel 这-->
  ...
  <button v-on:click="save">保存</button>
    <canvas id="canvas" width="375px" height="667px" >Canvas画板</canvas>
...
} } </script> <!-- Add "scoped" attribute to limit CSS to this component only --> <style scoped> h1, h2 { font-weight: normal; } ul { list-style-type: none; padding: 0; } li { display: inline-block; margin: 0 10px; } a { color: #42b983; } #canvas { position: fixed;width:100%;height:100%;left:0;top:0;background: pink; cursor: default; } #keyword-box { margin: 10px 0; } </style>